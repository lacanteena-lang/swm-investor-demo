        ...
        {isJourneyActive ? (
          ...
          <div className="mt-4 flex w-full min-w-0 items-center justify-between gap-3 rounded-2xl border border-cyan-400/20 bg-[#061329]/95 px-3 py-3">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="min-w-0">
                <p className="text-[8px] font-bold uppercase tracking-[0.04em] text-white">
                  NO ACTIVE JOURNEY
                </p>
                <p className="mt-1 text-[8px] text-white">
  ...
  <p className="text-[7px] font-semibold uppercase tracking-[0.16em] text-pink-300">
    ...
    />
          ...
          <div className="absolute bottom-4 right-3 z-40 flex flex-col gap-2">
            <MapButton symbol="location" onClick={() => setShowLocationPermissionIntro(true)} />
            <MapButton symbol="plus" onClick={() => setMapZoom((zoom) => Math.min(1.3, Number((zoom + 0.1).toFixed(2))))} />
            <MapButton symbol="minus" onClick={() => setMapZoom((zoom) => Math.max(0.85, Number((zoom - 0.1).toFixed(2))))} />
          </div>
        </div>
  ...
  <div className="mt-3 flex items-center gap-3">
    ...
    >
      CHANGE
        ...
        <div className="mt-3 grid w-full min-w-0 grid-cols-1 gap-2">
          <button
            type="button"
          ...
          >
            ...
            <div className="mt-3 grid grid-cols-1 gap-y-2">
              {[
                ...
                <span key={status} className="flex min-w-0 items-center gap-2">
                  <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-lime-400 shadow-[0_0_10px_rgba(163,230,53,0.85)]" />
                  <span className="truncate text-[10px] font-medium text-[#C76B4A]">
                    {status}
                  </span>
                </span>
              ))}
...
/>
          ...
          <button
            ...
            className="flex min-w-0 flex-col items-center justify-center rounded-2xl border border-[#FF3131] bg-[#16070c]/95 px-2 py-3 text-white shadow-[0_0_30px_rgba(255,49,49,0.75)] transition active:scale-95"
          >
            <span className="rounded-full border-2 border-[#FF3131] px-5 py-2 text-[16px] font-bold text-white shadow-[0_0_22px_rgba(255,49,49,0.95)]">
              SOS
            </span>
        ...
        <div className="mt-3 w-full rounded-2xl border border-cyan-400/20 bg-[#061329]/95 p-3">
          ...
          <div className="mt-3 grid grid-cols-4 gap-2">
            {[
              ...
              ["O", "Call Concierge", "", "Available 24/7"],
              ...
              <button
                ...
                className={`min-w-0 min-h-[100px] rounded-2xl border px-2.5 py-3 text-left transition active:scale-[0.98] ${
  index === 0
    ? "border-cyan-300 bg-cyan-500/[0.10] shadow-[0_0_24px_rgba(34,211,238,0.75)]"
    : index === 1
      ? "border-[#39FF14] bg-[#39FF14]/[0.08] shadow-[0_0_24px_rgba(57,255,20,0.75)]"
      : index === 2
        ? "border-fuchsia-300 bg-fuchsia-500/[0.10] shadow-[0_0_24px_rgba(217,70,239,0.75)]"
        : "border-orange-300 bg-orange-500/[0.10] shadow-[0_0_24px_rgba(251,146,60,0.75)]"
}`}
              >
                <div className={`text-[22px] font-bold leading-none ${
  index === 0
    ? "text-cyan-200 drop-shadow-[0_0_12px_rgba(34,211,238,1)]"
    : index === 1
      ? "text-[#39FF14] drop-shadow-[0_0_12px_rgba(57,255,20,1)]"
      : index === 2
        ? "text-fuchsia-200 drop-shadow-[0_0_12px_rgba(217,70,239,1)]"
        : "text-orange-200 drop-shadow-[0_0_12px_rgba(251,146,60,1)]"
}`}>{icon}</div>
  ...
  index === 0
    ? "text-cyan-200 drop-shadow-[0_0_5px_rgba(34,211,238,0.75)]"
    : index === 1
      ? "text-[#39FF14] drop-shadow-[0_0_5px_rgba(57,255,20,0.75)]"
      : index === 2
        ? "text-fuchsia-300 drop-shadow-[0_0_5px_rgba(217,70,239,0.75)]"
        : "text-orange-300 drop-shadow-[0_0_5px_rgba(251,146,60,0.75)]"
}`}>{sub}</p>
              </button>
            ))}
          </div>
        ...
        >
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-fuchsia-300 bg-fuchsia-500/15 text-xl font-bold text-fuchsia-200 shadow-[0_0_14px_rgba(217,70,239,0.75)]">
            *
          </div>
          ...
          <span className="shrink-0 text-2xl font-bold text-fuchsia-200 drop-shadow-[0_0_10px_rgba(217,70,239,1)]">{'>'}</span>
        </motion.button>
...
function MapButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-[#0B1727]/95 text-cyan-300 shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition active:scale-95"
    >
      {icon}
    </button>
  );
