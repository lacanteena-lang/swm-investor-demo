...
export default function OnboardingPlan() {
  ...
  className="
    ...
    border
    border-red-500
     border-2 border-red-500 shadow-[0_0_22px_rgba(239,68,68,0.85)] bg-cyan-300/10
    text-cyan-300
  ...
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <circle cx="12" cy="12" r="8" stroke="currentColor" strokeWidth="1.6" />
            ...
            <div className="mt-4 grid w-full grid-cols-3 gap-2">
              ...
              <Value title="AI-POWERED" icon="âœ¦" />

              <Value title="HUMAN-SUPPORTED" icon="â—‰" />

              <Value title="PRIVACY-FIRST" icon="â—‡" />
          ...
          <section className="mt-10 pb-8">
            ...
            <p className="mt-4 text-center text-[9px] text-white/75">
              Secure â€¢ Private â€¢ AI-Assisted â€¢ Human-Supported
            </p>
...
function Value({
  ...
  const glow = isAI
    ...
    : isHuman
    ? "shadow-[0_0_18px_rgba(236,72,153,0.65)]"
    : "shadow-[0_0_18px_rgba(250,204,21,0.65)]";

  return (
    <div
      className={`flex h-[76px] flex-col items-center justify-center rounded-[18px] border ${border} ${glow} bg-white/[0.045]`}
    >
      <div className={`mb-2 ${text} drop-shadow-[0_0_10px_currentColor]`}>
        {isAI ? (
          <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M12 2.5c.9 5.1 2.4 6.6 7.5 7.5-5.1.9-6.6 2.4-7.5 7.5-.9-5.1-2.4-6.6-7.5-7.5 5.1-.9 6.6-2.4 7.5-7.5Z"/>
          </svg>
        ) : isHuman ? (
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path d="M12 2.8 21.2 12 12 21.2 2.8 12 12 2.8Z" stroke="currentColor" strokeWidth="1.8"/>
          </svg>
        )}
      </div>
