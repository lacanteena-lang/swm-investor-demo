...
function Value({
  ...
  return (
    <div
      className={`flex h-[76px] flex-col items-center justify-center rounded-[18px] border ${styles.border} ${styles.glow} bg-white/[0.045]`}
    >
  ...
  return (
    <div
      className="
        rounded-[18px]
        border
        border-cyan-400 shadow-[0_0_22px_rgba(34,211,238,0.75)]
        bg-white/[0.045]
        px-4
        py-4
      "
