...
const plans = {
  ...
  premium: {
    ...
    subtitle: "Stay Ahead",
    price: "Ã¢â€šÂ¹149",
    yearly: "Ã¢â€šÂ¹1,499 / year  Ã¢â‚¬Â¢  Save 17%",
    badge: "MOST POPULAR",
  ...
  pro: {
    ...
    price: "Ã¢â€šÂ¹249",
    yearly: "Ã¢â€šÂ¹2,499 / year  Ã¢â‚¬Â¢  Save 16%",
    badge: "",
    button: "Go Pro",
    accent: "blue",
    features: [
        ...
        >
          ...
          <section className="flex flex-col items-center">
            ...
            <div className="mt-4 grid w-full grid-cols-3 gap-2">
              ...
              <Value title="AI-POWERED" icon="AI" />

              <Value title="HUMAN-SUPPORTED" icon="HS" />

              <Value title="PRIVACY-FIRST" icon="PF" />
              ...
              {otp.map((digit, index) => (
                ...
                <input
                  ...
                  className="
                    ...
                    rounded-[14px]
                    border
                    border-cyan-400/70`n        bg-white/[0.045]`n        shadow-[0_0_18px_rgba(34,211,238,0.45)]
                    text-center
                    text-[19px]
                    font-bold
                    text-white
          ...
          <section className="mt-10 pb-8">
            ...
            <p className="mt-4 text-center text-[9px] text-white/75">
              Secure Ã¢â‚¬Â¢ Private Ã¢â‚¬Â¢ AI-Assisted Ã¢â‚¬Â¢ Human-Supported
            </p>
